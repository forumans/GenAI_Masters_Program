...
class OptimizationState(TypedDict):
    initial_prompt: str # initial plain english prompt
...
# Add nodes
workflow.add_node("optimizer", generate_description)
...
if __name__ == "__main__":
    ...
    initial_data = {
        "initial_prompt": "Create a product description for a new fitness tracker called Fitpulse Pro. The target audience is health-conscious professionals aged 25-45 who value precision and reliability in their fitness equipment.",
        "product_name": "",
        "product_features": [],
        "target_audience": "",
        "current_description": "",
